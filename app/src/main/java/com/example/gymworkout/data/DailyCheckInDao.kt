...
interface DailyCheckInDao {
    ...
    @Query("SELECT COUNT(*) FROM daily_checkins WHERE habitsDone = 1 AND date BETWEEN :startDate AND :endDate")
    fun getHabitsDaysCount(startDate: String, endDate: String): Flow<Int>
